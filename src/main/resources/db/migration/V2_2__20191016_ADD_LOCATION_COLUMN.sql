...
/* Version:        2.1                                          */
/* Author:         WELLS                                           */
/* Description:    1.增加经纬度坐标系类型字段                        */
/* Description:    3.修改触发器函数，加经纬度坐标系类型               */
/*==============================================================*/

--增加经纬度坐标系类型字段

ALTER TABLE location_latest ADD COLUMN type varchar(64);
COMMENT ON COLUMN location_latest.type IS '坐标系类型';

ALTER TABLE location_history_day ADD COLUMN type varchar(64);
COMMENT ON COLUMN location_history_day.type IS '坐标系类型';

ALTER TABLE location_history_month ADD COLUMN type varchar(64);
COMMENT ON COLUMN location_history_month.type IS '坐标系类型';

ALTER TABLE location_history_year ADD COLUMN type varchar(64);
COMMENT ON COLUMN location_history_year.type IS '坐标系类型';
