...
/**
 * <p>Java class for queryOnlineDetailParams complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="queryOnlineDetailParams">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="fromLoginTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="fromLogoutTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="limit" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="offSet" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="toLoginTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="toLogoutTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
...
@XmlType(name = "queryOnlineDetailParams", propOrder = {
    "fromLoginTime",
    "fromLogoutTime",
    "limit",
    "offSet",
...
public class QueryOnlineDetailParams {

    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar fromLoginTime;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar fromLogoutTime;
    protected int limit;
    protected int offSet;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar toLoginTime;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar toLogoutTime;
    ...
    /**
     * Gets the value of the fromLoginTime property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public XMLGregorianCalendar getFromLoginTime() {
        return fromLoginTime;
    }

    /**
     * Sets the value of the fromLoginTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setFromLoginTime(XMLGregorianCalendar value) {
        this.fromLoginTime = value;
    }

    /**
     * Gets the value of the fromLogoutTime property.
     * 
     * @return
     *     possible object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public XMLGregorianCalendar getFromLogoutTime() {
        return fromLogoutTime;
    }

    /**
     * Sets the value of the fromLogoutTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setFromLogoutTime(XMLGregorianCalendar value) {
        this.fromLogoutTime = value;
    }
    ...
    /**
     * Gets the value of the toLoginTime property.
     * 
     * @return
     *     possible object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public XMLGregorianCalendar getToLoginTime() {
        return toLoginTime;
    }

    /**
     * Sets the value of the toLoginTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setToLoginTime(XMLGregorianCalendar value) {
        this.toLoginTime = value;
    }

    /**
     * Gets the value of the toLogoutTime property.
     * 
     * @return
     *     possible object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public XMLGregorianCalendar getToLogoutTime() {
        return toLogoutTime;
    }

    /**
     * Sets the value of the toLogoutTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setToLogoutTime(XMLGregorianCalendar value) {
        this.toLogoutTime = value;
    }
